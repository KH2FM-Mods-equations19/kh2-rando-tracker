...
@Composable
fun ItemPrototype.localizedName(showAnsemReportNumbers: Boolean = true): String {
  return when (this) {
    is AnsemReport -> stringResource(Res.string.ansem_report_n, if (showAnsemReportNumbers) reportNumber else "?")
